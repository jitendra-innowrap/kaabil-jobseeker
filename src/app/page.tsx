    ...
    <article>
      <section className='container'>
        ...
        <div className="flex flex-col sm:flex-row justify-between">
            <div className="block max-h-[200px] 2xl:max-h-[280px]  min-h-full md:w-[350px] mx-auto md:mx-0 2xl:max-w-[380px]  border-[#AEA3A3] border-[1px] rounded-[20px] p-[15px] lg:p-[20px] 2xl:p-[25px]">
      ...
      <section className="container my-5 md:my-7 xl:my-9 2xl:my-11">
        <div className="flex flex-col xl:flex-row gap-5 md:gap-7 xl:gap-8 2xl:gap-10">
          <div className="block">
            ...
            <div className="grid gap-4 mb-2 md:mb-3 md:gap-8 grid-cols-2 mt-8 md:mt-10 xl:mt-12 2xl:mt-14">
            ...
            <div className="flex max-w-[calc(100vw_-560px)] overflow-x-auto custom-scrollbar gap-2 md:gap-3">
              {["","","",""].map(()=>(
      ...
      <section className="container">
        <strong className="text-lg md:text-2xl font-bold block mt-10 lg:mt-20 mb-5 lg:mb-8">Life at Swiggy</strong>
        <GallarySlider/>
      </section>
      <section className="container">
