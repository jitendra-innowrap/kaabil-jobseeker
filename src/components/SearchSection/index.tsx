...
export default function SearchSection() {
  return (
    <div className="grid grid-cols-12 gap-2 md:gap-3">
          <input type="text" id='searchbar_input' placeholder="Enter Keywords or a job title, e.g. 'sales & marketing'" className="placeholder:line-clamp-1 col-span-12 md:col-span-6 min-w-[200px] xl:min-w-[480px] 2xl:min-w-[530px] px-6 py-2 xl:px-8 xl:py-4 rounded-full" />
          <Select
            // value={null}
