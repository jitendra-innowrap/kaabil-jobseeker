  ...
  return (
    <div style={{width:"-webkit-fill-available"}}>
            ...
            <div className="flex flex-col gap-4 md:gap-6">
              ...
              {/* Find By Salary */}
              <div className="border w-[calc(100vw_-_500px)] max-w-[920px] border-[#A7A7A7] bg-[#DBF0F6] rounded-[20px] justify-between px-4 sm:px-12 py-3 sm:py-7">
                <div className="block">
              ...
              {/* Update Profile Add */}
              <div className="border grid gap-5 md:gap-8 xl:gap-10 2xl:gap-16 md:grid-cols-4 w-[calc(100vw_-_500px)] max-w-[920px] border-[#A7A7A7] bg-[#DBF0F6] rounded-[20px] justify-between px-4 sm:px-12 py-3 sm:py-7">
